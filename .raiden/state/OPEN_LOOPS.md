...
| OL-005 | Open | Deployment | GHCR package visibility | After the first docker-publish.yml push, the sonarr-private package defaults to **private** on a private repository. Before Unraid can pull the image, go to GitHub Packages for StarlightDaemon/Sonarr-private and set the sonarr-private package visibility to **public**, or configure Docker registry credentials on Unraid. Action required before deployment. |
