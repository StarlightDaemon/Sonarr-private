Private homelab fork of Sonarr — complete-series and multi-season pack support. Active development, not for production use. General users should not fork, clone, or deploy. 
